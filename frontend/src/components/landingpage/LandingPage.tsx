...
const LandingPage: React.FC = () => {
    return (
        <div className="min-h-screen bg-gradient-to-br from-blue-50 to-white">
            ...
            <header className="container mx-auto max-w-screen-lg px-4 pt-16 pb-24 text-center">
            ...
            <section className="container mx-auto max-w-screen-lg px-4 py-24 text-center">
                ...
                <Link
                    to="/signup"
                    className="bg-blue-600 text-white px-8 py-4 rounded-full text-lg md:text-xl font-semibold hover:bg-blue-700 transition-colors shadow-lg hover:shadow-xl"
                >
